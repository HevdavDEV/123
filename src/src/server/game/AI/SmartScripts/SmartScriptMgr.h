...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SET_CORPSE_DELAY                   = 101,
    SMART_ACTION_SET_HOME_POS                       = 102,    // none
    SMART_ACTION_SET_HEALTH_REGEN                   = 103,    // 0/1
    SMART_ACTION_SET_ROOT                           = 104,    // off/on
    SMART_ACTION_SET_GO_FLAG                        = 105,    // Flags
    SMART_ACTION_ADD_GO_FLAG                        = 106,    // Flags
    SMART_ACTION_REMOVE_GO_FLAG                     = 107,    // Flags
    SMART_ACTION_SUMMON_CREATURE_GROUP              = 108,    // Group, attackInvoker
    SMART_ACTION_SET_POWER                          = 109,    // PowerType, newPower
    SMART_ACTION_ADD_POWER                          = 110,    // PowerType, newPower
    SMART_ACTION_REMOVE_POWER                       = 111,    // PowerType, newPower
    SMART_ACTION_GAME_EVENT_STOP                    = 112,    // GameEventId
    SMART_ACTION_GAME_EVENT_START                   = 113,    // GameEventId
