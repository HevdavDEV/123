...
enum Enchants
{
    ...
    ENCHANT_CHEST_GREATER_MANA_RESTO    = 2381, //3533,
    ...
    ENCHANT_BRACER_EXCEPTIONAL_INTELLECT= 1119,
    ...
    ENCHANT_BOOTS_ICEWALKER             = 3826, //2599,
    ENCHANT_BOOTS_GREATER_ASSAULT       = 1597,
    ENCHANT_BOOTS_GREATER_SPIRIT        = 1147, //528,
...
class npc_enchantment : public CreatureScript
{
    public:
        ...
        void ShowHeadMenu(Player* player, Creature* creature)
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Burning Mysteries -- 30 spell power + 20 critical", GOSSIP_SENDER_MAIN, 
                ENCHANT_HEAD_BURNING_MYSTERIES);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Dominance -- 29 spell power + 20 Resil ", GOSSIP_SENDER_MAIN, 
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of The Stalwart Protector -- 37 Stamina + 20 Defense", GOSSIP_SENDER_MAIN,
                ENCHANT_HEAD_STALWART_PROTECTOR);
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Arcanum of Torment --  50 attack power + 20 critical", GOSSIP_SENDER_MAIN,
        ...
        {
            player->PlayerTalkClass->ClearMenus();
            player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Exceptional Mana -- 250 Mana", GOSSIP_SENDER_MAIN, 
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            switch (action)
            {
                ...
                //case ENCHANT_BRACER_MAJOR_SPIRIT: movido a caso especial
                ...
                // Gloves
                //case ENCHANT_GLOVES_EXPERTISE: movido a caso especial
                ...
                case ENCHANT_BOOTS_NITRO_BOOSTS:
                    ...
                    break;
				// Casos especiales mismo enchant
