            ...
            uint32 GetStone(uint32 spellId, uint32 objectId)
            {
                switch (spellId)
                {
                    case SPELL_IMPROVED_HEALTH_STONE_R1:
                        return objectId == GO_SOUL_WELL_R2 ? ITEM_FEL_HEALTH_STONE_R1 : ITEM_MASTER_HEALTH_STONE_R1;
                    case SPELL_IMPROVED_HEALTH_STONE_R2:
                        return objectId == GO_SOUL_WELL_R2 ? ITEM_FEL_HEALTH_STONE_R2 : ITEM_MASTER_HEALTH_STONE_R2;
                    default:
                        return objectId == GO_SOUL_WELL_R2 ? ITEM_FEL_HEALTH_STONE_R0 : ITEM_MASTER_HEALTH_STONE_R0;
                }
                return 0;
            };
        };
