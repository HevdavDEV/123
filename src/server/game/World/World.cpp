...
void World::LoadConfigSettings(bool reload)
{
	...
	m_float_configs[CONFIG_ARENA_1V1_ARENAPOINTS_MULTI]				 = sConfigMgr->GetFloatDefault("Arena.1v1.ArenaPointsMulti", 0);
    ...
    m_bool_configs[CONFIG_DISABLE_HAPPINESS] = sConfigMgr->GetBoolDefault("DisableHappiness", true);
