...
public:
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature)
    {
		...
		pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Spectate Rated 1v1", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_5V5_GAMES);
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Spectate Rated 2v2", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_2V2_GAMES);
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Spectate Rated 3v3", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_3V3_GAMES);
        pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_CHAT, "Spectate Specific Player", GOSSIP_SENDER_MAIN, NPC_SPECTATOR_ACTION_SPECIFIC, "", 0, true);
