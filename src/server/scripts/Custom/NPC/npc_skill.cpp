...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
		if (player->GetSession()->GetSecurity() >= 249 && player->IsGameMaster())
			player->ADD_GOSSIP_ITEM(3, "|CFFFF0000GameMaster|R", GOSSIP_SENDER_MAIN, 10);
		player->ADD_GOSSIP_ITEM(3, "Class Skills, Weapons and Riding", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_TRAINER);
		if(player->GetSpecsCount() == 1 && !(player->getLevel() < sWorld->getIntConfig(CONFIG_MIN_DUALSPEC_LEVEL)))
			player->ADD_GOSSIP_ITEM(3, "Dual talent specialization learn", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_LEARNDUALSPEC);
		player->ADD_GOSSIP_ITEM(1, "Reset my talent points", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_UNLEARNTALENTS);
		if(player->getClass() == CLASS_HUNTER && player->GetPet())
			player->ADD_GOSSIP_ITEM(1, "Reset my pet talents", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_UNLEARNPETTALENTS);
		player->ADD_GOSSIP_ITEM(2, "Forget it", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_NONE);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*uiSender*/, uint32 uiAction)
    {
        ...
        switch (uiAction)
        {
			case 10:	//Solo GM
			{
				...
				player->GetSession()->SendAreaTriggerMessage("Skills Learned");
			...
			case GOSSIP_OPTION_LEARNDUALSPEC:
			{
				...
				player->CastSpell(player, 63680, true, NULL, NULL, player->GetGUID());
				player->CastSpell(player, 63624, true, NULL, NULL, player->GetGUID());
				player->GetSession()->SendAreaTriggerMessage("Learned Dual Specialization");
			}break;	
			...
			case GOSSIP_OPTION_UNLEARNTALENTS:
			{
				...
				player->GetSession()->SendAreaTriggerMessage("Talents restarted");
			}break;	

			case GOSSIP_OPTION_UNLEARNPETTALENTS:
			{
			player->ResetPetTalents();
			player->GetSession()->SendAreaTriggerMessage("Talents reset your pet");
			player->CLOSE_GOSSIP_MENU();
			}break;
			...
			if(player->getClass() == CLASS_WARRIOR)
			{
				...
				player->ADD_GOSSIP_ITEM( 5, "Warrior Skills", GOSSIP_SENDER_MAIN, 101);
			}

			if(player->getClass() == CLASS_DEATH_KNIGHT)
			{

				player->ADD_GOSSIP_ITEM( 5, "Death Knight Skills", GOSSIP_SENDER_MAIN, 102);
			}

			if(player->getClass() == CLASS_DRUID)
			{

				player->ADD_GOSSIP_ITEM( 5, "Druid Skills", GOSSIP_SENDER_MAIN, 103);
			}

			if(player->getClass() == CLASS_HUNTER)
			{

				player->ADD_GOSSIP_ITEM( 5, "Hunter Skills", GOSSIP_SENDER_MAIN, 104);
			}

			if(player->getClass() == CLASS_MAGE)
			{

				player->ADD_GOSSIP_ITEM( 5, "Mage Skills", GOSSIP_SENDER_MAIN, 105);
			}

			if(player->getClass() == CLASS_PALADIN)
			{

				player->ADD_GOSSIP_ITEM( 5, "Paladin Skills", GOSSIP_SENDER_MAIN, 106);
			}

			if(player->getClass() == CLASS_PRIEST)
			{

				player->ADD_GOSSIP_ITEM( 5, "Priest Skills", GOSSIP_SENDER_MAIN, 107);
			}

			if(player->getClass() == CLASS_ROGUE)
			{

				player->ADD_GOSSIP_ITEM( 5, "Rogue Skills", GOSSIP_SENDER_MAIN, 108);
			}

			if(player->getClass() == CLASS_SHAMAN)
			{

				player->ADD_GOSSIP_ITEM( 5, "Shaman Skills", GOSSIP_SENDER_MAIN, 109);
			}

			if(player->getClass() == CLASS_WARLOCK)
			{

				player->ADD_GOSSIP_ITEM( 5, "Warlock Skills", GOSSIP_SENDER_MAIN, 110);
			}
				player->SEND_GOSSIP_MENU(1, creature->GetGUID());
				}break;
			...
			// Horde
				...
				{
				// Hawkstrider
                    player->learnSpell(33660, false);
                    player->learnSpell(35025, false);
                    player->learnSpell(35027, false);
				//	Wolf
                    player->learnSpell(23250, false);
                    player->learnSpell(23251, false);
                    player->learnSpell(23252, false);
				//	Kodo
                    player->learnSpell(23249, false);
                    player->learnSpell(23248, false);
                    player->learnSpell(23247, false);
				//	Raptor
                    player->learnSpell(23241, false);
                    player->learnSpell(23242, false);
                    player->learnSpell(23243, false);
				//
                    player->learnSpell(17465, false);
                    player->learnSpell(66846, false);
                    player->learnSpell(23246, false);
				//	
                    player->learnSpell(32296, false);
                    player->learnSpell(32246, false);
                    player->learnSpell(32297, false);
                    player->learnSpell(32295, false);
				}
				else
				{
			// Alliancce
				// Elekk
                    player->learnSpell(35713, false);
                    player->learnSpell(35712, false);
                    player->learnSpell(35714, false);
			    // Ram
                    player->learnSpell(23238, false);
                    player->learnSpell(23240, false);
                    player->learnSpell(23239, false);
				// Mechanostrider
                    player->learnSpell(23225, false);
                    player->learnSpell(23223, false);
                    player->learnSpell(23222, false);
				// Steed
                    player->learnSpell(18777, false);
                    player->learnSpell(18776, false);
                    player->learnSpell(18778, false);
				// Saber
                    player->learnSpell(23221, false);
                    player->learnSpell(23219, false);
                    player->learnSpell(23338, false);
				// Gryphon
                    player->learnSpell(32242, false);
                    player->learnSpell(32290, false);
                    player->learnSpell(32289, false);
