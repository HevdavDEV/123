		   ...
		   if(sender == GOSSIP_SENDER_MAIN)
		   {
			   switch(actions)
			   {
			       case GOSSIP_ACTION_INFO_DEF+1:
				   {
					   ...
					   Field * fields = NULL;
					   player->GetSession()->SendNotification("|cff4169E1Here are the top 10 2v2 arena teams:|r");
					   do
					   {
						   fields = result->Fetch();
						   ...
						   player->GetSession()->SendNotification(msg, player->GetGUID());
			       ...
			       case GOSSIP_ACTION_INFO_DEF+2:
				   {
					   ...
					   Field * fields = NULL;
					   player->GetSession()->SendNotification("|cff4169E1Here are the top 10 3v3 arena teams:|r");
					   do
					   {
						   fields = result->Fetch();
						   string arena_name = fields[0].GetString();
